...
$string['safeassign_additionalroles_help'] = 'Los usuarios con estos roles en el nivel de sistema se agregarán a cada curso de SafeAssign
como profesores.';
...
$string['safeassign_license_warning'] = 'Hay un problema con la validación de los datos de la licencia de SafeAssign&trade;. Haga clic
en el botón "Probar conexión". Si la prueba es exitosa, vuelva a intentarlo más tarde.';
...
$string['safeassign_referencedbactivity'] = 'Actividad de la <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Base de datos de referencia global</a>';
...
$string['disclaimer'] = '<br>Con el envío de entregas a la <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Base de datos de referencia global</a> de SafeAssign, se pueden comparar trabajos de otras instituciones <br>
                        con los trabajos de sus estudiantes para proteger su origen.';
$string['settings'] = 'Ajustes de SafeAssign';
$string['timezone_help'] = 'Zona horaria establecida en su entorno de Blackboard Open LMS.';
...
$string['assignment_check_submissions_help'] = 'Si se establece el método de calificación anónima, los Originality Reports de SafeAssign no estarán disponibles para los profesores.
Sin embargo, los estudiantes sí podrán ver sus propios Originality Reports de SafeAssign si se selecciona la opción "Permitir que los estudiantes vean los Originality Reports".
...
Para obtener más información, consulte <a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">Ayuda de Blackboard</a>.';
$string['students_originality_report'] = 'Permitir que los estudiantes vean los Originality Reports';
$string['submissions_global_reference'] = 'No incluir las entregas de la <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Base de datos de referencia global</a> e institucional.';
...
$string['agreement'] = 'Acepto enviar mi(s) trabajo(s) a la <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Base de datos de referencia global</a>.';
...
$string['course_error_sync'] = 'Se produjo un error al intentar sincronizar el Curso con el ID: {$a} en SafeAssign: <br>';
$string['assign_error_sync'] = 'Se produjo un error al intentar sincronizar la Actividad con el ID: {$a} en SafeAssign: <br>';
$string['submission_error_sync'] = 'Se produjo un error al intentar sincronizar la Entrega con el ID: {$a} en SafeAssign: <br>';
...
$string['not_configured'] = 'SafeAssign&trade; no está configurado. Solicite al administrador del sistema que envíe un boleto a Behind the Blackboard para obtener ayuda.';
...
$string['messageprovider:safeassign_notification'] = 'SafeAssign envía notificaciones a los Administradores del sitio cuando hay Términos y condiciones de una Licencia nueva disponible';
$string['safeassign:get_notifications'] = 'Permitir notificaciones de SafeAssign';
$string['license_agreement_notification_subject'] = 'Términos y condiciones de Licencia nueva de SafeAssign disponible';
$string['license_agreement_notification_message'] = 'Puede aceptar los términos y las condiciones de la Licencia nueva aquí: {$a}';
$string['settings_page'] = 'Página Ajustes de SafeAssign';
$string['send_notifications'] = 'Enviar notificaciones de los Términos y las condiciones la Licencia nueva de SafeAssign.';
