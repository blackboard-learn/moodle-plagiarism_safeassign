...
$string['studentdisclosure_help'] = 'Este texto será exibido a todos os alunos na página de upload de arquivo. Se este campo ficar vazio,
a cadeia de caracteres localizada padrão (studentdisclosuredefault) será usada no lugar.';
...
$string['safeassign_additionalroles_help'] = 'Os usuários com essas funções no nível do sistema serão adicionados a cada curso do SafeAssign como instrutores.';
...
$string['safeassign_license_warning'] = 'Há um problema na validação dos dados de licença do SafeAssign&trade;. Clique
no botão "Testar conexão". Se o teste for bem-sucedido, tente novamente mais tarde.';
...
$string['safeassign_referencedbactivity'] = 'Atividade do <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>';
...
$string['disclaimer'] = '<br>Enviar para o SafeAssign <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> permite que documentos de outras instituições <br> sejam verificados em relação ao documentos dos alunos para proteger a origem do trabalho.';
$string['settings'] = 'Configurações do SafeAssign';
$string['timezone_help'] = 'O fuso horário definido no ambiente do Blackboard Open LMS.';
...
$string['assignment_check_submissions_help'] = 'Os Originality Reports do SafeAssign não estarão disponíveis para Professores se a avaliação anônima
 estiver definida, mas os Alunos conseguirão ver seus próprios Originality Reports do SafeAssign se a opção "Permitir que os alunos vejam o Originality Report" estiver selecionada.
<br><br>Embora o SafeAssign seja oficialmente compatível apenas com o inglês, os clientes podem tentar usar o SafeAssign com outros idiomas.
O SafeAssign não possui limitações técnicas que impeçam que ele seja usado com outros idiomas.
Consulte a <a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">Ajuda da Blackboard</a> para obter mais informações.';
$string['students_originality_report'] = 'Permitir que os alunos vejam o Originality Report';
$string['submissions_global_reference'] = 'Excluir envios da instituição e do <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>';
...
$string['files_accepted'] = 'O SafeAssign aceita somente arquivos nos formatos .doc, .docx, .docm, .ppt, .pptx, .odt, .txt, .rtf, .pdf e .html. Arquivos de qualquer outro formato, incluindo .zip e outros formatos de arquivos compactados, não serão verificados com o SafeAssign.
<br><br>Ao enviar este documento, você concorda:
 (1) que você está enviando seu documento para que seja usado e armazenado como parte dos serviços do SafeAssign&trade; de acordo com os <a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">Termos e Serviços</a> da Blackboard e com a <a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">Política de Privacidade da Blackboard</a>;
 (2) que sua instituição pode usar seu documento de acordo com as políticas da sua instituição; e
 (3) que seu uso do SafeAssign será sem recorrer contra a Blackboard Inc. e suas afiliadas.';
$string['agreement'] = 'Eu concordo em enviar meus documentos para o <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>.';
...
$string['course_error_sync'] = 'Ocorreu um erro ao tentar sincronizar o Curso com o código: {$a} no SafeAssign: <br>';
$string['assign_error_sync'] = 'Ocorreu um erro ao tentar sincronizar o Exercício com o código: {$a} no SafeAssign: <br>';
$string['submission_error_sync'] = 'Ocorreu um erro ao tentar sincronizar o Envio com o código: {$a} no SafeAssign: <br>';
...
$string['not_configured'] = 'O SafeAssign&trade; não está configurado. Peça ao administrador do sistema para enviar um aviso em Behind the Blackboard para assistência.';
...
$string['send_notifications'] = 'Enviar ao SafeAssign notificações sobre novos Termos e Condições de Licença.';
