...
$string['studentdisclosure_help'] = 'Tento text se zobrazí všem studentům na stránce nahrání souboru. Pokud pole ponecháte prázdné, použije se místo toho výchozí lokalizovaný řetězec (studentdisclosuredefault).';
...
$string['safeassign_referencedbactivity'] = 'Aktivita <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">globální referenční databáze</a>';
...
$string['disclaimer'] = '<br>Odesláním do  <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">globální referenční databáze</a> služby SafeAssign umožníte, aby byly práce z jiných institucí <br>
                        kontrolovány oproti pracím vašich studentů, aby byla ochráněna původnost jejich práce.';
$string['settings'] = 'Nastavení služby SafeAssign';
$string['timezone_help'] = 'Časové pásmo nastavené ve vašem prostředí Blackboard Open LMS';
$string['timezone'] = 'Časové pásmo';
$string['safeassign_status'] = 'Stav služby SafeAssign';
$string['status:pending'] = 'Nevyřízeno';
...
$string['assignment_check_submissions_help'] = 'Když je nastavena anonymní klasifikace, nebudou učitelům k dispozici sestavy původnosti SafeAssign, studenti si však budou své sestavy původnosti moci zobrazit v případě, že je vybrána možnost Povolit studentům zobrazit sestavu původnosti.
<br><br>I když služba SafeAssign oficiálně podporuje pouze angličtinu, klienti mohou zkusit službu SafeAssign použít i s jinými jazyky.
Služba SafeAssign nemá žádná technická omezení, která by bránila využití s jinými jazyky.
Další informace naleznete v  <a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">nápovědě Blackboard</a>.';
$string['students_originality_report'] = 'Povolit studentům zobrazit sestavu původnosti';
$string['submissions_global_reference'] = 'Vyloučit odevzdání z instituční a <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">globální referenční databáze</a>';
...
$string['files_accepted'] = 'Služba SafeAssign přijímá pouze soubory ve formátech .doc, .docx, .docm, .ppt, .pptx, .odt, .txt, .rtf, .pdf a .html. Soubory v jiných formátech, včetně .zip a dalších komprimovaných formátů, nebudou službou SafeAssign zkontrolovány.
<br><br>Odesláním této práce souhlasíte s následujícím:
 (1) Odesíláte svou práci s tím, že bude použita a uložena jako součást služeb SafeAssign&trade; v souladu se <a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">smluvními podmínkami</a> společnosti Blackboard a <a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">zásadami ochrany osobních údajů společnosti Blackboard</a>.
 (2) Vaše instituce může vaši práci použít v souladu s jejími zásadami.
 (3) Vaše použití služby SafeAssign bude bez postihu vůči společnosti Blackboard Inc. a jejím přidruženým společnostem.';
$string['agreement'] = 'Souhlasím s odesláním své práce do <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">globální referenční databáze</a>.';
...
$string['not_configured'] = 'Služba SafeAssign&trade; není nakonfigurována. Pokud potřebujete pomoc, požádejte správce systému, aby odeslal ticket do služby Behind the Blackboard.';
...
$string['license_agreement_notification_message'] = 'Nové licenční smluvní podmínky můžete akceptovat zde: {$a}';
