...
$string['safeassign_cachedefault'] = '<div class="form-defaultinfo text-muted">&nbsp Valeur par défaut : 0</div> <br>';
...
$string['safeassign_referencedbactivity'] = 'Activité <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>';
...
$string['disclaimer'] = '<br>L\'envoi à la base de données <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> de SafeAssign permet de comparer les travaux d\'autres établissements <br>
                        avec ceux de vos étudiants afin de s\'assurer qu\'il n\'existe pas de similitudes.';
$string['settings'] = 'Paramètres de SafeAssign';
$string['timezone_help'] = 'Fuseau horaire défini dans votre environnement Blackboard Open LMS.';
...
$string['assignment_check_submissions_help'] = 'Les rapports de similitude SafeAssign ne seront pas disponibles pour les enseignants si la notation anonyme
 est activée. Les étudiants pourront toutefois consulter leur rapport de similitude SafeAssign si l\'option « Autoriser les étudiants à consulter le rapport de similitude » est sélectionnée.
<br><br>Bien que, de manière officielle, SafeAssign ne prenne en charge que l\'anglais, les clients peuvent essayer d\'utiliser SafeAssign avec d\'autres langues.
SafeAssign ne présente, en effet, aucune limitation technique empêchant de l\'utiliser avec d\'autres langues.
Pour plus d\'informations, consultez l\'<a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">aide de Blackboard</a>.';
$string['students_originality_report'] = 'Autoriser les étudiants à consulter le rapport de similitude';
$string['submissions_global_reference'] = 'Exclure les travaux remis depuis le référentiel de l\'établissement et la base de données <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>';
...
$string['files_accepted'] = 'SafeAssign accepte uniquement les formats de fichiers .doc, .docx, .docm, .ppt, .pptx, .odt, .txt, .rtf, .pdf et .html. Les fichiers dans d\'autres formats, notamment .zip et autres formats compressés, ne seront pas vérifiés à l\'aide de SafeAssign.
<br><br>En remettant ce devoir, vous reconnaissez :
 (1) remettre votre devoir afin qu\'il soit utilisé et stocké dans le cadre des services SafeAssign&trade; conformément aux <a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">modalités du contrat de service</a> de Blackboard et à la <a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">politique de confidentialité de Blackboard</a> ;
 (2) que votre établissement peut utiliser votre devoir conformément aux règles en vigueur dans votre établissement ; et
 (3) que votre utilisation de SafeAssign n\'entraînera aucun recours contre Blackboard Inc. et ses affiliés.';
$string['agreement'] = 'J\'accepte de soumettre mon ou mes devoirs à la base de données <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>.';
...
$string['not_configured'] = 'SafeAssign&trade; n\'est pas configuré. Demandez à votre administrateur système de créer un ticket sur Behind the Blackboard pour obtenir de l\'aide.';
