...
$string['studentdisclosure_help'] = '將在檔案上傳頁面上對所有學員顯示此文字。如果
將此欄位留空，則將改用預設本地化字串 (學員揭露預設值)。';
...
$string['safeassign_additionalroles_help'] = '在系統層級具有這些角色的使用者將做為講師新增至
每門 SafeAssign 課程。';
...
$string['safeassign_license_warning'] = '驗證 SafeAssign&trade; 授權資料時發生問題，請按一下
「測試連線」按鈕。如果測試成功，請稍後再試一次。';
...
$string['disclaimer'] = '<br>送出至 SafeAssign <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> 可允許對照其他機構的文件<br>
                        檢查您的學員文件，以保護其作品的原創性。';
$string['settings'] = 'SafeAssign 設定';
$string['timezone_help'] = '在您的 Blackboard Open LMS 環境中設定的時區。';
$string['timezone'] = '時區';
...
$string['assignment_check_submissions_help'] = 'SafeAssign Originality Report 在已設定匿名評分時不可供教師使用，
但是在選取「允許學員檢視 Originality Report」時，可讓學員檢視其自己的 SafeAssign Originality Report。
<br><br>雖然 SafeAssign 僅正式支援英文，但也歡迎客戶嘗試在 SafeAssign 中使用非英文語言。
SafeAssign 沒有技術限制會阻止在其中使用其他語言。
如需詳細資訊，請參閱 <a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">Blackboard 說明</a>。';
$string['students_originality_report'] = '允許學員檢視 Originality Report';
$string['submissions_global_reference'] = '從機構參考資料庫和 <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> 中排除送出項目';
...
$string['files_accepted'] = 'SafeAssign 僅接受 .doc、.docx、.docm、.ppt、.pptx、.odt、.txt、.rtf、.pdf 和 .html 檔案格式的檔案。SafeAssign 不會針對任何其他格式 (包括 .zip 和其他壓縮檔案格式) 的檔案進行檢查。
<br><br>送出此文件即表示您同意：
 (1) 您送出的文件可供 SafeAssign&trade; 服務在符合 Blackboard <a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">條款與條件</a>和 <a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">Blackboard 隱私權政策</a>的情況下進行使用和儲存；
 (2) 貴機構可在符合貴機構政策的情況下使用您的文件；以及
 (3) 您使用 SafeAssign 對於 Blackboard Inc. 及其附屬機構無追索權。';
$string['agreement'] = '我同意將我的文件送出至 <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>。';
...
$string['course_error_sync'] = '嘗試將編號為 {$a} 的課程同步至 SafeAssign 時發生錯誤：<br>';
$string['assign_error_sync'] = '嘗試將編號為 {$a} 的作業同步至 SafeAssign 時發生錯誤：<br>';
$string['submission_error_sync'] = '嘗試將編號為 {$a} 的送出項目同步至 SafeAssign 時發生錯誤：<br>';
...
$string['not_configured'] = '未配置 SafeAssign&trade;。請讓您的系統管理員在 Behind the Blackboard 上送出票證，以尋求協助。';
...
$string['safeassign_overall_score'] = '<b>SafeAssign 總得分：{$a}%</b>';
