...
$string['studentdisclosure_help'] = 'このテキストはファイルアップロードページですべての学生に表示されます。この
フィールドを空のままにすると、代わりにデフォルトのローカライズされた文字列 (studentdisclosuredefault) が使用されます。';
$string['safeassignexplain'] = 'このプラグインの詳細については、こちらを参照してください : ';
$string['safeassign'] = 'SafeAssign盗作プラグイン';
$string['safeassign:enable'] = '教師が活動内でSafeAssignを有効/無効にすることを許可する';
...
$string['safeassign_instructor_password'] = '共有秘密鍵';
$string['safeassign_instructor_password_help'] = 'SafeAssignによって提供される教員の共有秘密鍵です。';
...
$string['safeassign_student_password'] = '共有秘密鍵';
$string['safeassign_student_password_help'] = 'SafeAssignによって提供される学生の共有秘密鍵です。';
...
$string['safeassign_license_header'] = 'SafeAssign&trade;ライセンス契約条件';
...
$string['safeassign_license_warning'] = 'SafeAssign&trade;ライセンスデータの検証に問題があります。[テスト接続]ボタンを
クリックしてください。テストが成功した場合、後ほどやり直してください。';
...
$string['safeassign_referencedbactivity'] = '<a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>活動';
...
$string['safeassign_credentials_fail'] = '接続が確認されませんでした。キー、秘密鍵、URLを確認してください。';
$string['credentials'] = '認証情報とサービスURL';
$string['shareinfo'] = 'SafeAssignと情報を共有する';
$string['disclaimer'] = '<br>SafeAssignへの送信<a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>を使用すると、他の機関の論文を学生の論文と照合して、<br>
                        研究の起源を保護できます。';
$string['settings'] = 'SafeAssign設定';
$string['timezone_help'] = 'Blackboard Open LMS環境に設定されたタイムゾーン。';
...
$string['assignment_check_submissions_help'] = 'SafeAssign Originality Reportは、匿名評定が設定されている場合、教師は利用できませんが、
[学生にオリジナリティレポートの表示を許可する]が選択されている場合、学生は自分のSafeAssign Originality Reportを表示できます。
<br><br>公式にはSafeAssignは英語のみサポートしていますが、クライアントはSafeAssignを英語以外の言語で使用してみることを歓迎しています。
SafeAssignには、他言語で使用することを妨げる技術的制限はありません。
詳細については、<a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">Blackboardヘルプ</a>を参照してください。';
$string['students_originality_report'] = '学生にオリジナリティレポートの表示を許可する';
$string['submissions_global_reference'] = '教育機関および<a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>からの提出物を除外する';
...
$string['files_accepted'] = 'SafeAssignは、.doc、.docx、.docm、.ppt、.pptx、.odt、.txt、.rtf、.pdf、および.html形式のファイルのみ受け入れます。.zipやその他の圧縮ファイル形式など、これ以外の形式のファイルはSafeAssignを介してチェックされません。
<br><br>この論文を提出することにより、以下に同意するものとします :
 (1) Blackboard<a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">利用規約</a>および<a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">Blackboardプライバシーポリシー</a>に従って、SafeAssign&trade;サービスの一部として使用され、保存される論文を提出していること、
 (2) 所属教育機関が、提出した論文を教育機関のポリシーに従って使用できること、および
 (3)SafeAssignの使用にはBlackboard Inc.およびその関連会社に対する請求権がないこと。';
$string['agreement'] = '<a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a>に論文を提出することに同意します。';
...
$string['assign_error_sync'] = 'ID : {$a}の課題をSafeAssign に同期しようとしてエラーが発生しました : <br>';
...
$string['not_configured'] = 'SafeAssign&trade;が設定されていません。支援のため、Behind the Blackboardにチケットを送信することをシステム管理者に依頼してください。';
...
$string['privacy:metadata:plagiarism_safeassign_course:courseid'] = 'SafeAssignが有効になっている活動があるコース。';
...
$string['privacy:metadata:plagiarism_safeassign_subm:submissionid'] = 'SafeAssignが有効になっている活動の提出物ID。';
