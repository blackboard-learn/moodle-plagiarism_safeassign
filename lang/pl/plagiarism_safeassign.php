...
$string['safeassign_additionalroles_help'] = 'Użytkownicy o przypisanych tych rolach na poziomie systemu zostaną dodani do każdego kursu SafeAssign
jako instruktorzy.';
...
$string['safeassign_instructor_password'] = 'Współdzielony tajny klucz';
...
$string['safeassign_student_password'] = 'Współdzielony tajny klucz';
...
$string['safeassign_referencedbactivity'] = 'Aktywność <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">globalnej referencyjnej bazy danych</a>';
...
$string['disclaimer'] = '<br>Przesłanie do <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">globalnej referencyjnej bazy danych</a> SafeAssign umożliwia porównanie prac studentów<br>
z pracami pochodzącymi z innych instytucji w celu ochrony ich oryginalności.';
$string['settings'] = 'Ustawienia usługi SafeAssign';
$string['timezone_help'] = 'Strefa czasowa ustawiona w środowisku systemu Open LMS.';
$string['timezone'] = 'Strefa czasowa';
$string['safeassign_status'] = 'Status usługi SafeAssign';
$string['status:pending'] = 'Oczekujący';
...
$string['assignment_check_submissions_help'] = 'Raporty usługi SafeAssign dotyczące oryginalności nie są dostępne dla nauczycieli, jeśli ustawiono ocenianie anonimowe,
ale studenci mogą wyświetlać swoje własne raporty SafeAssign dotyczące oryginalności, jeśli wybrano opcję „Pozwól studentom na wyświetlanie raportów dotyczących oryginalności”.
<br><br>SafeAssign generuje jeden Raport dotyczący oryginalności, gdy użytkownicy prześlą wiele plików. Możesz wybrać, który plik przeglądać z poziomu tego raportu.
<br><br>Choć usługa SafeAssign oficjalnie obsługuje tylko język angielski, możesz spróbować korzystać z niej w innych językach.
SafeAssign nie ma technicznych ograniczeń, które uniemożliwiałyby korzystanie z tej usługi w innych wersjach językowych.
...
$string['submissions_global_reference'] = 'Wyklucz prace z <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">globalnej referencyjnej bazy danych</a>';
...
$string['files_accepted'] = 'SafeAssign akceptuje wyłącznie pliki w formatach .doc, .docx, .docm, .ppt, .pptx, .odt, .txt, .rtf, .pdf i .html. Pliki w innych formatach, w tym w formacie .zip i innych formatach plików skompresowanych, nie będą sprawdzane przy użyciu usługi SafeAssign.
<br><br>Przesłanie pracy jest równoznaczne z uznaniem, że:
(1) przesłana praca będzie używana i przechowywana w ramach usług SafeAssign&trade; zgodnie z <a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">Warunkami korzystania z usługi</a> Blackboard oraz <a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">Zasadami ochrony prywatności firmy Blackboard</a>;
(2) instytucja użytkownika może użyć pracy zgodnie z własnymi zasadami, a także
(3) korzystanie z usługi SafeAssign nie będzie się wiązało z odpowiedzialnością firmy Blackboard Inc. ani podmiotów od niej zależnych.';
$string['agreement'] = 'Zgadzam się przesłać prace do <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">globalnej referencyjnej bazy danych</a>.';
...
$string['not_configured'] = 'Usługa SafeAssign&trade; nie jest skonfigurowana. Aby uzyskać pomoc, poproś administratora systemu o przesłanie zgłoszenia
do <a href="https://support.openlms.net/" target="_blank" rel="noopener">Działu wsparcia Open LMS</a>.';
...
$string['safeassign_notification_subm_singular'] = 'złożona praca';
