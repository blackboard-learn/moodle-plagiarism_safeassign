...
$string['studentdisclosure_help'] = 'Dieser Text wird allen Teilnehmern auf der Datei-Upload-Seite angezeigt. Wenn
dieses Feld leer ist, wird stattdessen der lokalisierte Standard-String (studentdisclosuredefault) verwendet.';
...
$string['safeassign_additionalroles_help'] = 'Nutzer/innen mit diesen Rollen auf Systemebene werden zu jedem
SafeAssign-Kurs als Kursleiter hinzugefügt.';
...
klicken Sie auf „Verbindung testen“. Wenn der Test erfolgreich ist, versuchen Sie es später erneut.';
...
$string['safeassign_referencedbactivity'] = '<a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> Aktivität';
...
$string['disclaimer'] = '<br>Durch das Einreichen bei der SafeAssign <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> können Arbeiten von anderen Institutionen <br>
                        mit den Arbeiten Ihrer Teilnehmer/innen abgeglichen werden, um Plagiate zu vermeiden.';
$string['settings'] = 'SafeAssign-Einstellungen';
$string['timezone_help'] = 'Die in Ihrer Blackboard Open LMS-Umgebung festgelegte Zeitzone.';
...
$string['test_credentials'] = 'Verbindung testen';
...
$string['assignment_check_submissions_help'] = 'Wenn die anonyme Bewertung eingestellt ist, stehen SafeAssign-Echtheitsberichte Trainer/innen
nicht zur Verfügung, Teilnehmer/innen können jedoch ihre eigenen SafeAssign-Echtheitsberichte anzeigen, wenn „Teilnehmer/innen das Anzeigen des Echtheitsberichts gestatten“ ausgewählt ist.
<br><br>Zwar unterstützt SafeAssign offiziell nur Englisch, Nutzer/innen können jedoch versuchen, SafeAssign mit anderen Sprachen als Englisch zu nutzen.
SafeAssign verfügt über keine technischen Einschränkungen, die die Nutzung mit anderen Sprachen ausschließen.
Weitere Informationen finden Sie in der <a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">Blackboard-Hilfe</a>.';
$string['students_originality_report'] = 'Teilnehmern das Anzeigen des Echtheitsberichts gestatten';
$string['submissions_global_reference'] = 'Übermittlungen von Institutionen und <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> ausschließen';
...
$string['files_accepted'] = 'SafeAssign akzeptiert nur Dateien in den Formaten .doc, .docx, .docm, .ppt, .pptx, .odt, .txt, .rtf, .pdf und .html. Dateien in anderen Formaten, darunter .zip und andere komprimierte Formate, werden nicht durch SafeAssign überprüft.
<br><br>Mit der Übermittlung dieser Arbeit stimmen Sie zu, dass:
 (1) Ihre übermittelte Arbeit im Rahmen der SafeAssign&trade;-Services in Einklang mit den Blackboard-<a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">Servicebestimmungen</a> und der <a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">Blackboard-Datenschutzrichtlinie</a> verwendet und gespeichert wird;
 (2) Ihre Institution Ihre Arbeit in Einklang mit den Richtlinien Ihrer Institution verwenden kann; und
 (3) Ihre Nutzung von SafeAssign ohne Regressansprüche gegenüber Blackboard Inc. und seinen Tochtergesellschaften erfolgt.';
$string['agreement'] = 'Ich stimme der Einreichung meiner Arbeit(en) bei der <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign#global_reference" target="_blank">Global Reference Database</a> zu.';
...
$string['not_configured'] = 'SafeAssign&trade; ist nicht konfiguriert. Bitten Sie Ihren Systemadministrator, ein Support-Ticket bei Behind the Blackboard einzureichen.';
...
$string['messageprovider:safeassign_notification'] = 'SafeAssign sendet Benachrichtigungen an den Website-Administrator, wenn neue Lizenzbestimmungen verfügbar sind';
