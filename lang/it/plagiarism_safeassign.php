...
$string['studentdisclosure_help'] = 'Questo testo verrà mostrato a tutti gli studenti sulla pagina di caricamento del file. Se questo
campo rimane vuoto, al suo posto verrà utilizzata la stringa predefinita localizzata (studientdisclosurespredef).';
...
$string['safeassign_instructor_password'] = 'Segreto condiviso';
...
$string['safeassign_student_password'] = 'Segreto condiviso';
...
$string['safeassign_license_warning'] = 'Si è verificato un problema durante la convalida dei dati della licenza SafeAssign&trade;;
fare clic sul pulsante "Verifica connessione". Se la verifica ha esito positivo, riprovare più tardi.';
...
$string['safeassign_referencedbactivity'] = 'Attività <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">Global Reference Database</a>';
...
$string['safeassign_credentials_fail'] = 'Connessione non verificata. Controllare chiave, segreto e URL.';
$string['credentials'] = 'Credenziali e URL servizio';
$string['shareinfo'] = 'Condividi informazioni con SafeAssign';
$string['disclaimer'] = '<br>La consegna al <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">Global Reference Database</a> di SafeAssign consente di controllare i compiti degli altri istituti<br>
confrontandoli con quelli dei propri studenti per proteggere l\'originalità del loro lavoro.';
$string['settings'] = 'Impostazioni SafeAssign';
$string['timezone_help'] = 'Il fuso orario impostato nel tuo ambiente Open LMS.';
$string['timezone'] = 'Fuso orario';
$string['safeassign_status'] = 'Stato SafeAssign';
$string['status:pending'] = 'In stato di attesa';
...
$string['test_credentials'] = 'Verifica connessione';
...
$string['assignment_check_submissions_help'] = 'Gli Originality Report di SafeAssign non saranno disponibili per i docenti se è stata impostata la valutazione anonima;
gli studenti saranno tuttavia in grado di visualizzarli, se l\'opzione "Consenti agli studenti di visualizzare i report sull\'originalità" è selezionata.
<br><br>SafeAssign restituisce un unico Originality Report quando gli utenti inviano più file. All\'interno del report è possibile scegliere quali file esaminare.
<br><br>Sebbene SafeAssign supporti ufficialmente solo la lingua inglese, gli utenti possono provare a utilizzare SafeAssign in lingue diverse.
SafeAssign non presenta limiti tecnici che ne precludono l\'utilizzo in altre lingue.
Visita la pagina di <a href="http://www.blackboard.com/docs/documentation.htm?DocID=191SafeAssign001en_US" target="_blank">assistenza Blackboard</a> per ulteriori informazioni.';
$string['students_originality_report'] = 'Consenti agli studenti di visualizzare il report sull\'originalità';
$string['submissions_global_reference'] = 'Escludi le richieste dal <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">Global Reference Database</a>';
$string['submissions_global_reference_help'] = 'Le consegne saranno sempre elaborate da SafeAssign ma non saranno registrate in un database. In questo modo i file non verranno contrassegnati come plagio quando i docenti consentono la riconsegna per un compito specifico.';
$string['plagiarism_tools'] = 'Strumenti plagio';
$string['files_accepted'] = 'SafeAssign accetta solo i file nei formati .doc, .docx, .docm, .ppt, .pptx, .odt, .txt, .rtf, .pdf e .html. I file di qualsiasi altro formato, compresi i file .zip e altri formati compressi, non saranno verificati da SafeAssign.
<br><br>Consegnando questo elaborato accetti:
(1) che l\'elaborato consegnato venga utilizzato e archiviato presso i servizi SafeAssign&trade; in accordo con i <a href="http://www.blackboard.com/safeassign/tos.htm" target="_blank">Termini di servizio</a> e la <a href="http://blackboard.com/footer/privacy-policy.aspx" target="_blank">Politica sulla privacy di Blackboard</a>;
(2) che l\'istituto possa utilizzare il tuo elaborato in accordo con le politiche dell\'istituto;
(3) che il tuo utilizzo di SafeAssign non comporti un ricorso contro Open LMS e le sue affiliate.';
$string['agreement'] = 'Accetto di consegnare il/i mio/miei elaborato/i a <a href="https://help.blackboard.com/Learn/Instructor/Assignments/SafeAssign" target="_blank">Global Reference Database</a>.';
...
$string['course_error_sync'] = 'Si è verificato un errore durante il tentativo di sincronizzazione del corso con ID: {$a} in SafeAssign:<br>';
$string['assign_error_sync'] = 'Si è verificato un errore durante il tentativo di sincronizzazione del compito con ID: {$a} in SafeAssign:<br>';
$string['submission_error_sync'] = 'Si è verificato un errore durante il tentativo di sincronizzazione della consegna con ID: {$a} in SafeAssign:<br>';
...
$string['not_configured'] = 'SafeAssign&trade; non è configurato. Chiedere all\'amministratore di sistema di inviare un ticket
al <a href="https://support.openlms.net/" target="_blank" rel="noopener">supporto Open LMS</a> per ricevere assistenza.';
...
$string['originality_report_unavailable'] = 'Il report sull\'originalità richiesto non è disponibile. Riprovare più tardi o contattare l\'amministratore di sistema.';
...
$string['safeassign_overall_score'] = '<b>Punteggio complessivo SafeAssign: {$a}%</b>';
