...
Feature: SafeAssign displays the submission processing message only when there is a submission
  ...
  Scenario: SafeAssign shows Report in progress... only when files are submitted.
    ...
    And I should see "Draft (not submitted)" in the "(//div[@class='submissionstatusdraft'])[1]" "xpath_element"
    And I should not see "SafeAssign Originality Report in progress..." in the "//tr[1]//td[@class='cell c8']" "xpath_element"
    And I should see "Draft (not submitted)" in the "(//div[@class='submissionstatusdraft'])[2]" "xpath_element"
    And I should not see "SafeAssign Originality Report in progress..." in the "//tr[2]//td[@class='cell c8']" "xpath_element"
    Then I log out
    Given I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Assignment One"
    ...
    And I follow "Assignment One"
    And I navigate to "View all submissions" in current page administration
    And I should see "Submitted for grading" in the "(//div[@class='submissionstatussubmitted'])[1]" "xpath_element"
    And I should see "SafeAssign Originality Report in progress..." in the "//tr[1]//td[@class='cell c8']" "xpath_element"
    And I should see "Submitted for grading" in the "(//div[@class='submissionstatussubmitted'])[2]" "xpath_element"
    And I should see "SafeAssign Originality Report in progress..." in the "//tr[2]//td[@class='cell c8']" "xpath_element"
    Then I am on "Course 1" course homepage
    And I follow "Assignment Two"
    And I navigate to "View all submissions" in current page administration
    And I should see "Submitted for grading" in the "(//div[@class='submissionstatussubmitted'])[1]" "xpath_element"
