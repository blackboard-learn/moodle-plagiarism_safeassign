...
#
# Tests for visibility of resubmission button for originality report.
#
...
Feature: Show resubmit button for originality report
  As an editing Teacher
  I should be able to see resubmit button for originality report
  ...
  @javascript
  Scenario: Teacher with editing permits should see the resubmit button
    ...
    And I wait until the page is ready
    And I should see "Select Sources & Resubmit"
